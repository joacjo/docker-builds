...
def main():
  ...
  parser.add_option("-s", "--split", dest="split_character", help="Character for splitting bins", metavar="STRING")
  ...
  #clusterfile = 'vamb_cpu2/clusters.tsv'
  #bindir = 'vamb_cpu2/darkmatterbins' 
